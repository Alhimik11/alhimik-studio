...
const services = [
  {
    ...
    description: 'Создаем рекламные ролики, презентации и контент с использованием нейросетей. От концепта до финального монтажа.',
    features: ['Рекламные AI-ролики', 'Продуктовая анимация', 'Корпоративные презентации'],
